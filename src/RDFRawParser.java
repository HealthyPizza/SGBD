...
public final class RDFRawParser {
	...
	public static void main(String args[]){
		...
		Parser p=new Parser();
		try {
			p.parse("SELECT ?x WHERE ?x http://swat.cse.lehigh.edu/onto/univ-bench.owl#teacherOf http://www.Department1.University0.edu/Course0 . ?x http://swat.cse.lehigh.edu/onto/univ-bench.owl#mastersDegreeFrom http://www.University509.edu");
			if(!p.isPath()){
